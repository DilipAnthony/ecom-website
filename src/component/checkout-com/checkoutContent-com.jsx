        ...
        <div className="checkout-parent">
            <div className="checkout-title">
                ...
                {cartItems.map(item => {
                    return(
                        <div className="checkout-title">
                        <img className="title-child img" src={item.imageUrl} width="120px" height="150px" />
                        <h1 className="title-child name">{item.name}</h1> 
                        <h1 className="title-child quantity"><div>-</div>{item.quantity}<div>+</div></h1>
                        <h1 className="title-child price">{item.price}</h1>
                        <div className="title-child X" onClick={() => CartClearItems(item)}><h1>X</h1></div>
                        </div>
                    )
                })}
                ...
                <div>
                <input className="submit child" id="check-out" type="submit" value="Pay now"/>
                </div>
